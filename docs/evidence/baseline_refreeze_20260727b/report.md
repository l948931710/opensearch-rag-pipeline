...
- **Run**: eval_refreeze_20260727b  |  **Table**: `?`  |  **Generated**: 20260727_235836
...
## Verdict: 37 passed / 5 failed / 2 n-a

| Gate | Target | Value | Result |
|---|---|---|---|
| index_health (L0) | all gates pass | True | ✅ PASS |
| retrieval recall@5 (L1) | >= 0.85 (xlsx 正例召回率@5) | 0.9568 | ✅ PASS |
...
| off-topic discrimination AUC (L2) | >= 0.85 (pos vs off-topic-negative top-1 separation) | 0.984 | ✅ PASS |
...
| answer keyword-coverage (L3, 完整性) | >= 0.70 | 0.706 | ✅ PASS |
...
| <<IMG:N>> marker validity (L4-srv) | >= 0.95 hard / >= 0.98 soft | 0.9878 | ✅ PASS |
| dangling 口惠图但卡片无图 (L4-srv) | <= 0.05 hard (扩正则后) | 0.0286 | ✅ PASS |
| orphan rate (L4-srv, trend 监控) | <= 0.30 soft (trend, advisory) | 0.3545 | ❌ FAIL |
| marker distinctness (L4-srv, advisory) | advisory — 1.0 = no image reuse (lower = bundled/reused markers) | 0.8765 | ❌ FAIL |
| answer image rate (L4-srv, advisory) | advisory — trend (锁分布后再定阈值; 主臂=生产 cosurface=False 姿态) | 0.8571 | ➖ N/A |
...
| [L6-soft] mid-sentence cut rate (B) | CI-upper <= 0.05 | 0.326 | ❌ FAIL |
...
| judge inter-rater agreement (L6 chunk panel) | mean overall inter-judge stdev <= 1.2 (1-5 scale) | 0.179 | ✅ PASS |
| answer faithfulness (Claude, L3) | >= 4.0 / 5 | 4.939 | ✅ PASS |
| answer correctness (Claude, L3) | >= 4.0 / 5 | 4.444 | ✅ PASS |
| answer completeness (Claude, L3) | >= 4.0 / 5 | 4.204 | ✅ PASS |
| positive fabrication (Claude, L3) | <= 0.05 | 0.009 | ✅ PASS |
| negative fabrication (Claude, L3) | <= 0.10 | 0.0 | ✅ PASS |
| judge inter-rater agreement (L3 panel) | mean overall inter-judge stdev <= 1.2 (1-5 scale; lower=more agreement) | 0.069 | ✅ PASS |
| image relevance (judge-mm, advisory) | >= 3.5 advisory（caption 贴题率;先锁两轮分布再议升 hard） | 3.838 | ✅ PASS |
...
| baseline regression (regime) | baseline regime must match run regime to compare | REGIME MISMATCH on ['l4_serving_evaluator_version', 'l4_serving_set_sha'] — baseline not comparable | ➖ N/A |

## L0 — Index Health

- status/docCount: {"pass": true, "status": "IN_USE", "docCount": 27484, "rds_active": 27484, "delta": 0, "tolerance": 137, "interpretation": "exact match"}
- dense self-query: {"pass": true, "healthy": 60, "total": 60, "id_exact_match": 53, "identical_text_sibling": 7, "self_score_min_seen": 1.0, "self_score_mean": 1.0, "fails_sample": [], "note": "healthy = self-score>=0.99 returning same chunk or an identical-text sibling"}
...
- duplicate-content diagnostic: {"exact_id_self_match_rate": 0.883, "identical_text_sibling_rate": 0.117, "note": "high identical-text-sibling rate => duplicate chunk content (chunking quality), not an index fault"}

## L1 — Retrieval Ranking

- scorable positives: 165 public / 165 total  |  permission-gated excluded: 0  |  negatives: 33
- **ranking (single-target)**: {"n_queries": 162, "recall@1": 0.8704, "recall@1_ci": [0.8148, 0.9198], "recall@3": 0.9568, "recall@3_ci": [0.9198, 0.9815], "recall@5": 0.9568, "recall@5_ci": [0.9198, 0.9815], "recall@10": 0.9568, "recall@10_ci": [0.9198, 0.9815], "mrr": 0.9106, "mrr_ci": [0.8701, 0.9469], "found_rate": 0.9753, "ndcg@10": 0.8852, "ndcg@10_ci": [0.8484, 0.9175]}
...
- by module: {"rag_retrieval": {"n": 29, "recall@1": 1.0, "recall@5": 1.0, "mrr": 1.0}, "nlq": {"n": 89, "recall@1": 0.831, "recall@5": 0.955, "mrr": 0.89}, "source_attribution": {"n": 19, "recall@1": 0.947, "recall@5": 1.0, "mrr": 0.974}, "rag_retrieval_json": {"n": 25, "recall@1": 0.8, "recall@5": 0.88, "mrr": 0.833}}
- by source: {"xlsx": {"n": 137, "recall@1": 0.883, "recall@5": 0.971, "mrr": 0.925}, "json_text": {"n": 25, "recall@1": 0.8, "recall@5": 0.88, "mrr": 0.833}}
- by difficulty: {"None": {"n": 145, "recall@1": 0.89, "recall@5": 0.972, "mrr": 0.929}, "cross_chunk": {"n": 9, "recall@1": 0.889, "recall@5": 0.889, "mrr": 0.889}, "single_chunk": {"n": 3, "recall@1": 0.0, "recall@5": 0.667, "mrr": 0.278}, "disambiguation": {"n": 2, "recall@1": 0.5, "recall@5": 0.5, "mrr": 0.5}, "query_robustness": {"n": 3, "recall@1": 1.0, "recall@5": 1.0, "mrr": 1.0}}
- latency (ms): {"mean": 11389.4, "p50": 11287, "p90": 14822, "p95": 16782, "p99": 19493}

## L2 — Score Calibration

- thresholds: {"high": 0.9, "medium": 0.8}
- n_correct_top1_positives: 141
- positive_top1_mean: 0.9125
- negative_top1_mean: 0.6991
- separation_pos_minus_neg: 0.2135
- label_bands_on_correct_hits: {"高": 98, "中": 33, "低": 10}
- frac_高: 0.695
- frac_at_least_中: 0.929
- frac_negatives_in_高: 0.182
- neg_high_by_type: {"off_topic": 0.0, "untyped": 0.231}
- n_offtopic_neg: 7
- separation_auc_offtopic: 0.984
- thresholds_ok: true
...
```json
{
 ...
 "positives_fabrication_rate": 0.009,
 "mean_overall_interjudge_stdev": 0.069,
 "pass_rate_overall_ge4_positives": 0.822
}
```
...
{
 "n_answers": 35,
 "n_answers_with_images": 28,
 "answer_image_rate": 0.8571428571428571,
 "interleave_rate": 0.8571428571428571,
 "orphan_rate": 0.35454545454545455,
 "orphan_rate_all": 0.5328947368421053,
 "n_available_visible": 110,
 "n_available_all": 152,
 "marker_validity": 0.9878048780487805,
 "marker_distinctness": 0.8765432098765432,
 "dangling_ref_rate": 0.02857142857142857,
 "over_cap_rate": 0.35714285714285715,
 "placement_rate": 0.8571428571428571,
 "avg_images_shown": 3.5357142857142856,
 "total_markers": 82,
 "total_invalid_markers": 1,
 "total_inrange_markers": 81,
 "total_distinct_markers": 71,
 "n_referenced_none_strategy": 4,
 "n_appended_strategy": 4
}
```
...
- fingerprint: {"active_chunks": 27484, "active_docs": 1481, "chunk_id_set_hash": "a8752660cb5ed728", "d7_json_hash": "62f2476c2b048c99", "code_commit": "6c88ffa", "rubric_version": "chunk_rubric_v1"}
...
```json
{
 ...
 "token_drift_sample": [],
 "n_prose": 10447,
 "midsentence_cut_rate": 0.326,
 "midsentence_cut_ci": [
  0.3005,
  0.3523
 ],
 "midsentence_unique_docs": 837,
 "midsentence_n_scored": 4192,
 "midsentence_sample": [
  {
   "doc_id": "DOC_PRODUCTION_20260514123029_3455D6",
   "v": 1.0,
   "chunk_id": "DOC_PRODUCTION_20260514123029_3455D6_v2_c0008_77451DF8",
   "tail": "                         时间：2025.1.10\n\nFL-SC-001\n\n硅油纸生产工艺流程图"
  },
  {
   "doc_id": "DOC_PRODUCTION_20260514123029_3455D6",
   "v": 1.0,
   "chunk_id": "DOC_PRODUCTION_20260514123029_3455D6_v2_c0012_FBB0AD36",
   "tail": "                          时间：2025.1.10\n\nFL-SC-001\n\n纸杯生产工艺流程图"
  },
  {
   "doc_id": "DOC_PRODUCTION_20260514123029_3455D6",
   "v": 1.0,
   "chunk_id": "DOC_PRODUCTION_20260514123029_3455D6_v2_c0014_81F54AED",
   "tail": "                      时间：2025.1.10\n\nFL-SC-001\n\n纸杯（覆膜）生产工艺流程图"
  },
  {
   "doc_id": "DOC_PRODUCTION_20260514123027_8C73BA",
   "v": 1.0,
   "chunk_id": "DOC_PRODUCTION_20260514123027_8C73BA_v2_c0000_B8B2B23F",
   "tail": "上希望大家自觉遵守，如有违反将按条款处理，对屡教不改者将取消更衣室及储物柜使用资格。\n注塑事业部\n2023年11月20日"
  },
  {
   "doc_id": "DOC_ADMIN_20260513120217_08D91B",
   "v": 1.0,
   "chunk_id": "DOC_ADMIN_20260513120217_08D91B_v2_c0000_2A281E21",
   "tail": "励20-200元不等。\n举报他人违规违纪现象的，经核查属实的，给予奖励10-100元不等。\n富岭科技股份有限公司\n行政部"
  },
  {
   "doc_id": "DOC_ADMIN_20260513120215_8ACBA8",
   "v": 1.0,
   "chunk_id": "DOC_ADMIN_20260513120215_8ACBA8_v2_c0000_078B71B6",
   "tail": "车正常故障及非人为损坏，由行政部安排维修，非正常损\n坏由领用部门/领用人自行承担。\n领用部门：\n承 诺 人：\n领用日期："
  },
  {
   "doc_id": "DOC_ADMIN_20260513120215_766809",
   "v": 1.0,
   "chunk_id": "DOC_ADMIN_20260513120215_766809_v2_c0001_EB7C7C78",
   "tail": ",屡教不改者,视为严重违反公司纪律,将视情节严重处以相关处分并取消停车资格。\n富岭科技股份有限公司\n2023年3月15日"
  },
  {
   "doc_id": "DOC_ADMIN_20260513120215_4A992E",
   "v": 1.0,
   "chunk_id": "DOC_ADMIN_20260513120215_4A992E_v2_c0000_0D256A3C",
   "tail": "响用餐，如有变动会另行通知。\n本通知自发布之日起实施，请各部门负责人宣贯到位！\n行政部\n2024 年 12 月 17 日"
  },
  {
   "doc_id": "DOC_PRODUCTION_20260513120639_E1D6F8",
   "v": 1.0,
   "chunk_id": "DOC_PRODUCTION_20260513120639_E1D6F8_v2_c0000_F06DF13F",
   "tail": "单---品质主管签字报废---转接主任助理出报废明细单--转主管主任签字(主任主管商议责任明确)---主任交接給区域班长"
  },
  {
   "doc_id": "DOC_PRODUCTION_20260513120639_E1D6F8",
   "v": 1.0,
   "chunk_id": "DOC_PRODUCTION_20260513120639_E1D6F8_v2_c0001_E3D6D73F",
   "tail": "管（协同员工携带报废品）\n\n---料房主管核查并安排处理废品并签字送单回部门经理\n\n---部门经理签字后交王鸿图整理归档"
  }
 ],
 "trailing_heading_rate": 0.1266,
 "trailing_heading_ci_upper": 0.143,
...
```json
{
 ...
 "mean_overall_interjudge_stdev": 0.179,
