...
@app.post("/api/kb/contributions", response_model=KbContributionItem)
...
@app.get("/api/kb/contributions/mine", response_model=KbContributionListResponse)
...
@app.get("/api/kb/contributions/pending", response_model=KbContributionListResponse)
...
@app.post("/api/kb/contributions/{cid}/accept", response_model=KbContributionActionResponse)
...
@app.post("/api/kb/contributions/{cid}/reject", response_model=KbContributionActionResponse)
...
@app.post("/api/kb/contributions/{cid}/retry-ingestion", response_model=KbContributionActionResponse)
...
@app.get("/api/kb/contributions/heroes", response_model=KbHeroesResponse)
...
@app.get("/api/kb/gaps", response_model=KbGapsResponse)
