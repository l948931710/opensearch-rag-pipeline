...
| mean_jaccard_pdf | 0.8389 | 0.8389 | +0.0000 |
| n_anchors_evaluated | 22 | 22 | - |
| n_docs | 3 | 3 | - |
| n_strong_chunks | 30 | 30 | - |
| semantic_anchor_dual_hits | 19 | 21 | - |
| semantic_anchor_dual_jaccard | 0.8636 | 0.9545 | +0.0909 |
| semantic_anchor_key_hits | 22 | 22 | - |
| semantic_anchor_key_jaccard | 1.0000 | 1.0000 | +0.0000 |
| std_jaccard_pdf | 0.3260 | 0.3515 | - |

## Win/Tie/Loss (per metric)

- **jaccard_pdf**: win=1 tie=28 loss=1
- **semantic_anchor_dual**: win=2 tie=20 loss=0
